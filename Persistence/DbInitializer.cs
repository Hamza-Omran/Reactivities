...
public class DbInitializer
{
    public static async Task SeedData(AppDbContext context, UserManager<User> userManager)
    {
        ...
        {
            // now we do initialize the ids here to make the life easier in postman like  new() {Id = "bob-id", DisplayName = "Bob", UserName = "bob@test.com", Email= "bob@test.com"},
        ...
        // this is just to truck so EF know it is in memory and tracked
