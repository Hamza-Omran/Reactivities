...
export default function ActivityDetailsHeader({activity}: Props) {
    ...
    return (
        <Card sx={{ position: 'relative', mb: 2, backgroundColor: 'transparent', overflow: 'hidden', borderRadius: 1 }}>
        ...
        <Box sx={{
            ...
            <Box>
                ...
                <Typography variant="subtitle2">
                    Hosted by <Link to={`/profile/${activity.hostId}`} style={{ color: 'white', fontWeight: 'bold' }}>{activity.hostDisplayName}</Link>
                </Typography>
            </Box>
